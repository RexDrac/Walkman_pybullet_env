...
class Run():
    def __init__(self, config, dir_path):
        ...
        self.env = Valkyrie(
            max_time=self.max_time, renders=True, initial_gap_time=0.5, PD_freq=self.PD_freq,
...
def main():
    ...
    dir_path = 'TRPO/record/3D_walk_imitation/without_external_force_disturbance/2018_07_23_22.26.38'  # '2017_05_29_18.23.49/with_force'
