...
from valkyrie_gym_env.Hill_muscle_controller import HillMuscleController
...
class Valkyrie(gym.Env):
    ...
    def _setupSimulation(self, base_pos_nom=None, base_orn_nom=None, fixed_base=False, q_nom=None):
        ...
        if self.isEnableSelfCollision == True:
            valkyrie_urdf = self.dir_path + "/valkyrie_bullet_mass_sims_modified_foot_collision_box_soft_contact_self_collision.urdf"
            flags = p.URDF_USE_INERTIA_FROM_FILE|p.URDF_USE_SELF_COLLISION
        else:
            valkyrie_urdf = self.dir_path + "/valkyrie_bullet_mass_sims_modified_foot_collision_box_soft_contact.urdf"
